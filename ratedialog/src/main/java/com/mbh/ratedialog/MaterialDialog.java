...
public class MaterialDialog {
    ...
    private int positiveId = -1, negativeId = -1, neutralId = -1;
    ...
    private int dip2px(float dpValue) {
        // TODO: Check this value on orientation change
//        final float scale = mContext.getResources().getDisplayMetrics().density;
    ...
    private class Builder {
        ...
        private LinearLayout buttonPNLayout;
        ...
        private Builder() {
            ...
            buttonPNLayout = (LinearLayout) mAlertDialogWindow.findViewById(R.id.buttonPNLayout);
            ...
            mNeutralButton = (Button) mButtonLayout.findViewById(R.id.btn_neutral);
            ...
            if (negativeId != -1) {
                ...
                mNegativeButton.setText(negativeId);
            ...
            if (neutralId != -1) {
                ...
                mNeutralButton.setText(neutralId);
                mNeutralButton.setOnClickListener(neutralListener);
                if (isLollipop()) {
                    mNeutralButton.setElevation(0);
                }
            }
            if (!isNullOrEmpty(positiveText)) {
                mPositiveButton.setVisibility(View.VISIBLE);
            ...
            if (!isNullOrEmpty(neutralText)) {
                mNeutralButton.setVisibility(View.VISIBLE);
                mNeutralButton.setText(neutralText);
                mNeutralButton.setOnClickListener(neutralListener);
                if (isLollipop()) {
                    mNeutralButton.setElevation(0);
                }
            }
            if (isNullOrEmpty(positiveText) && positiveId == -1) {
                mPositiveButton.setVisibility(View.GONE);
            }
            if (isNullOrEmpty(negativeText) && negativeId == -1) {
                mNegativeButton.setVisibility(View.GONE);
            }

            if (isNullOrEmpty(neutralText) && neutralId == -1) {
        ...
        public void setNegativeButton(String text, final View.OnClickListener listener) {
            ...
            button.setOnClickListener(listener);
            if (buttonPNLayout.getChildCount() > 0) {
                params.setMargins(20, 0, 10, dip2px(BUTTON_BOTTOM));
                button.setLayoutParams(params);
                buttonPNLayout.addView(button, 1);
            } else {
                button.setLayoutParams(params);
                buttonPNLayout.addView(button);
            }
...
//        return nText == null || nText.isEmpty();
        return nText == null || nText.length() == 0;
    }
